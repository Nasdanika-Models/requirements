...
public enum Icon {
    ...
    REQUIREMENT(RequirementsPackage.Literals.REQUIREMENT, "requirement.svg");

    private static final String BASE_URL = "https://requirements.models.nasdanika.org/images/";
